# AI_GO/EXTERNAL_MEMORY/runtime/external_memory_runtime_bridge.py
...
def _persistence_value_weight(payload: Dict[str, Any]) -> float:
    ...
    if headline and any(term in headline for term in ["confirmed", "official", "filing", "earnings", "guidance"]):
        score += 4.0
...
def run_external_memory_runtime_path(payload: Dict[str, Any]) -> Dict[str, Any]:
