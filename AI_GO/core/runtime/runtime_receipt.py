...
RUNTIME_RECEIPT_MUTATION_CLASS = "runtime_receipt_persistence"
RUNTIME_RECEIPT_PERSISTENCE_TYPE = "filesystem"
RUNTIME_RECEIPT_ADVISORY_ONLY = False
...
def _classification_block() -> Dict[str, Any]:
    return {
        "mutation_class": RUNTIME_RECEIPT_MUTATION_CLASS,
        "persistence_type": RUNTIME_RECEIPT_PERSISTENCE_TYPE,
        "advisory_only": RUNTIME_RECEIPT_ADVISORY_ONLY,
