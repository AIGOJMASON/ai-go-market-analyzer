...
Stage 1 note:
- this page remains an internal/operator live dashboard harness
- customer-facing project intake now lives on the separate intake route
"""
...
<head>
  <meta charset="utf-8" />
  <title>AI_GO Contractor Live Dashboard</title>
...
<body>
  <div class="wrap">
    <div class="topbar">
      <div>
        <div class="title">AI_GO Contractor Live Dashboard</div>
        <div class="subtitle">
          Internal/operator governed read surface. This page calls the single live contractor endpoint,
          shows the validated dashboard payload, and can trigger phase closeout / signoff email for the
          currently loaded phase. Stage 1 project intake now lives on a separate intake page.
        </div>
      </div>
      <div class="nav">
