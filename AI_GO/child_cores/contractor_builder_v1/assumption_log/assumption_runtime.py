"""
Assumption runtime for contractor_builder_v1.

This module creates, appends, and transitions assumption records under append-only
posture. Assumptions are never deleted; status changes produce new records.
...
def _authority_metadata(operation: str, project_id: str = "") -> Dict[str, Any]:
    return {
        ...
        "layer": "assumption_log.assumption_runtime",
...
def _authority_block() -> Dict[str, Any]:
    return {
        "authority_id": "contractor_assumption_runtime",
        "can_execute": False,
