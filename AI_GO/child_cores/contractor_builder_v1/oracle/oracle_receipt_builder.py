# AI_GO/child_cores/contractor_builder_v1/oracle/oracle_receipt_builder.py
...
def build_oracle_receipt(
    *,
    ...
    if event_type_clean not in DECLARED_ORACLE_EVENTS:
        raise ValueError(f"Undeclared oracle receipt event: {event_type_clean}")
...
def write_oracle_receipt(
    ...
    *,
    ...
    result = write_contractor_receipt(
        module_name="oracle",
        event_type=str(receipt.get("event_type", "oracle_event")),
        receipt=receipt,
