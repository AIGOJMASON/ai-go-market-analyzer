# AI_GO/child_cores/contractor_builder_v1/workflow/workflow_receipt_builder.py
...
DECLARED_WORKFLOW_EVENTS = {
    "create_phase_plan",
    "update_phase_state",
    "record_client_signoff",
    "reconcile_workflow_state",
    "rollback_declined_signoff",
}
...
def build_workflow_receipt(
    *,
    ...
    if event_type_clean not in DECLARED_WORKFLOW_EVENTS:
        raise ValueError(f"Undeclared workflow receipt event: {event_type_clean}")
...
def write_workflow_receipt(
    ...
    *,
    ...
    result = write_contractor_receipt(
        ...
        event_type=str(receipt.get("event_type", "workflow_event")),
        receipt=receipt,
